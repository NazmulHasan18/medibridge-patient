...
const Introduction = () => {
    ...
    uniqueValue: [
      {
        ...
        class: "border-4 hover:bg-green-200 border-green-200",
      },
      {
        ...
        class: "border-4 hover:bg-gray-200 border-gray-200",
      },
      {
        ...
        class: "border-4 hover:bg-amber-200 border-amber-200",
      },
      {
        ...
        class: "border-4 hover:bg-blue-200 border-blue-200",
      },
    ],
  };
  ...
  return (
    <section className="lg:grid lg:grid-cols-11 gap-6 my-14 justify-items-center items-center">
      ...
      <div className="py-14 px-6 md:px-16 bg-blue-300 bg-[url(/images/image6.jpg)] bg-blend-soft-light bg-cover bg-center bg-opacity-50 dark:bg-opacity-30 rounded-xl col-span-7 h-auto">
        <h2 className="text-4xl text-white dark:text-black font-bold mb-4">{introductionData.title}</h2>
        <div className="w-72 h-1 bg-white dark:bg-black mb-4"></div>
        <p className="text-gray-900 dark:text-gray-200 mb-8 bg-white dark:bg-black rounded-lg p-7">
          ...
          {introductionData.uniqueValue.map((point, index) => (
            ...
            >
              <CardHeader className="flex gap-4 justify-center items-center flex-row">
                ...
                <CardDescription className="text-gray-700 dark:text-gray-400 text-sm">
                  {point.text}
                </CardDescription>
              </CardHeader>
            </Card>
